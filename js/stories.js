...
async function toggleFavStory(evt){
  ...
  const story = storyList.stories.find(favorite => favorite.storyId === storyId);
  ...
  if ($target.hasClass("far")) {
    ...
    currentUser.favorites = _.remove(currentUser.favorites, favorite => favorite.storyId !== story.storyId);
